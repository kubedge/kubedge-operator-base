...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KubedgeConditions) DeepCopyInto(out *KubedgeConditions) {
	{
		in := &in
		*out = make(KubedgeConditions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubedgeConditions.
func (in KubedgeConditions) DeepCopy() KubedgeConditions {
	if in == nil {
		return nil
	}
	out := new(KubedgeConditions)
	in.DeepCopyInto(out)
	return *out
}
