...
import (
	...
	conditions "github.com/kubedge/kubedge-operator-base/pkg/conditions"
...
func (h *Helper) patchStatusConditions(ctx context.Context, obj client.Object, forceOverwrite bool, ownedConditions []av1.KubedgeConditionType) error {
