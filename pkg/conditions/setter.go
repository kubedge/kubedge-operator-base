...
type Setter interface {
	Getter
	SetConditions(av1.KubedgeConditions)
}
...
func Set(to Setter, condition *av1.KubedgeCondition) {
...
func TrueCondition(t av1.KubedgeConditionType) *av1.KubedgeCondition {
	return &av1.KubedgeCondition{
		Type:   t,
...
func FalseCondition(t av1.KubedgeConditionType, reason av1.KubedgeConditionReason, severity av1.KubedgeConditionSeverity, messageFormat string, messageArgs ...interface{}) *av1.KubedgeCondition {
	return &av1.KubedgeCondition{
		Type:     t,
...
func UnknownCondition(t av1.KubedgeConditionType, reason av1.KubedgeConditionReason, messageFormat string, messageArgs ...interface{}) *av1.KubedgeCondition {
	return &av1.KubedgeCondition{
		Type:    t,
		Status:  av1.ConditionStatusUnknown,
		Reason:  reason,
		Message: fmt.Sprintf(messageFormat, messageArgs...),
	}
}
...
func MarkTrue(to Setter, t av1.KubedgeConditionType) {
	Set(to, TrueCondition(t))
}

// MarkUnknown sets Status=Unknown for the condition with the given type.
func MarkUnknown(to Setter, t av1.KubedgeConditionType, reason av1.KubedgeConditionReason, messageFormat string, messageArgs ...interface{}) {
...
func MarkFalse(to Setter, t av1.KubedgeConditionType, reason av1.KubedgeConditionReason, severity av1.KubedgeConditionSeverity, messageFormat string, messageArgs ...interface{}) {
...
func SetMirror(to Setter, targetCondition av1.KubedgeConditionType, from Getter, options ...MirrorOptions) {
...
func SetAggregate(to Setter, targetCondition av1.KubedgeConditionType, from []Getter, options ...MergeOption) {
	Set(to, aggregate(from, targetCondition, options...))
}

// Delete deletes the condition with the given type.
func Delete(to Setter, t av1.KubedgeConditionType) {
	if to == nil {
		return
	}

	conditions := to.GetConditions()
	newConditions := make(av1.KubedgeConditions, 0, len(conditions))
...
func lexicographicLess(i, j *av1.KubedgeCondition) bool {
	return (i.Type == av1.ConditionRunning || i.Type < j.Type) && j.Type != av1.ConditionRunning
}
...
func hasSameState(i, j *av1.KubedgeCondition) bool {
