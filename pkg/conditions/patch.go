...
type PatchOperation struct {
	Before *av1.KubedgeCondition
	After  *av1.KubedgeCondition
...
type applyOptions struct {
	ownedConditions []av1.KubedgeConditionType
	forceOverwrite  bool
}

func (o *applyOptions) isOwnedCondition(t av1.KubedgeConditionType) bool {
...
func WithOwnedConditions(t ...av1.KubedgeConditionType) ApplyOption {
